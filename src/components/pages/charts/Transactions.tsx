    ...
    <ResponsiveContainer width="100%">
      <ComposedChart data={networkStats} margin={{ top: 10, right: 20, left: 20, bottom: 10 }} stackOffset="sign">
        ...
        <YAxis
          ...
          label={{ value: t('charts.titles.transactions'), angle: -90, position: 'insideLeft' }}
          width={80}
        />
        <Tooltip
        ...
        />
        <Line type="monotone" dataKey={`txs`} name={t('charts.titles.transactions')} stroke="#8884d8" dot={false} />
