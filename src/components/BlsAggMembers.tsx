...
export const ParticipatedMembers = ({ bvHex, sig, members, isLoading }: { bvHex: string, sig: string, members: string[], isLoading: boolean }) => {
  return (
    <Table>
      <Tbody>
        <TableRow overflowWrap={'normal'} whitespace={'pre'} label={'Aggregation Bits'}>{bitsGrid(getBitsetStrFromHex(bvHex))}</TableRow>
